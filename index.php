...
<html>
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li><a class="dropdown-item" href="literature.php">fiction & literature</a></li>
                                <li><a class="dropdown-item" href="classic1.php">classic</a></li>
    ...
    <div class="div5">
	 ...
	 <?php
              $sql = "SELECT bookname,authorname,price,bookimage,id FROM books limit 12";
