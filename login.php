...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($username) && !empty($password) && !is_numeric($username))
		{
			...
			//read from database
			$query = "select * from registered where username = '$username' limit 1";
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="tooba.css">
	...
	<?php 
     ...
     <div class="maindiv">
       ...
       <div>  <label class="labels">PASSWORD</label> 
         ...
         <div> <input class="rbtn" input type="submit" name="login" value="LOGIN"></div>
         </form>
